  ...
  return (
    <>
      ...
      <div className="w-full h-screen bg-primaryLight">
        <Navbar />
        <div className="relative w-10/12 text-center mx-auto mt-12 z-20">
        ...
        <img
          src="/images/Yellow_cat.svg"
          alt="catYellow"
          className="absolute bottom-16 left-0 w-8/12 z-10"
        />
        <img
